                ...
                <div class="card card-small card-post card-post--1">
                  <div class="card-post__image img-card-cover">
                    ...
                    <div class="card-post__author d-flex">
                      <a href="#" class="card-post__author-avatar card-post__author-avatar--small" style="background-image: url({{ \yal\laraveldash\Helper\Helper::UploadedAvatar($get_post->user) }});">{{ $get_post->user->name }}</a>
                    </div>
                  </div>
                  <div class="card-body">
                    <h5 class="card-title">
              ...
              <div class="col-lg-4">
                <div class="card card-small card-post mb-4">
                  ...
                  <div class="card-footer border-top d-flex">
                    <div class="card-post__author d-flex">
                      <a href="#" class="card-post__author-avatar card-post__author-avatar--small" style="background-image: url({{ \yal\laraveldash\Helper\Helper::UploadedAvatar($get_post->user) }});">Written by James Khan</a>

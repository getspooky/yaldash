  ...
  @component("yal\laraveldash::components.navbar")
    ...
    @endcomponent
      ...
      <article id="top" class="wrapper style1">
        <div class="container">
          <div class="row">
            <div class="col-lg-4">
              <span class="image fit"><img src="{{ \yal\laraveldash\Helper\Helper::UploadedAvatar(\App\User::find(auth()->id())) }}" alt="" /></span>
            </div>
      ...
      @component("yal\laraveldash::components.state",['POST'=>$POST,'EARNINGS'=>$EARNINGS])
    ...
    @endcomponent
      ...
      <div class="row mt-5">
        ...
        @component("yal\laraveldash::components.referrals")
    ...
    @component("yal\laraveldash::components.footer",["top"=>"-55px"])

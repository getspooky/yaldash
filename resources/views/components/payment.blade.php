<div class="tab-pane" style="display:block;">
  <div class="row">
    ...
    <div class="col-lg-8">
      ...
      <stripe-component route="{{ route('dashboard.checkout.charges') }}" csrf="{{ session()->token() }}" stripekey="{{ config('services.stripe.key') }}" amount="{{\yal\laraveldash\Helper\Helper::amount()}}"></stripe-component>
    </div>

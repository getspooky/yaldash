...
<div class="page-header row no-gutters py-4">
    ...
    <div class="container-galeria">
        ...
        <div class="main_slider" style="background:url({{\Yasser\LaravelDashboard\Helper\Assets::loadImg('sell_background.jpg')}})">
                ...
                <div class="row align-items-center fill_height">
                    <div class="col">
                        <div class="main_slider_content">
                            ...
                            <div data-toggle="modal" data-target="#exampleModalCenter" class="red_button launch_now_button">Launch now</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="product-grid8">
                    ...
                    <div class="product-content">
                        ...
                        <h3 class="title"><a href="#"><input name="description" required class="sell_input" style="width:100% !important;" type="text" placeholder="Describe Your Product "></a></h3>

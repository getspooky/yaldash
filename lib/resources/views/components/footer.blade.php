    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-6 footer-col">
                ...
                <p>Laravel Dashboard provides a powerful user interfaces for CRUD (create, read, update, delete) operations for Laravel applications. It offers additonal features including searching, Charts , Panel Management , Settings , Payment System and Store</p>
                <p><i class="fa fa-map-pin"></i> Morocco , Casablanca</p>
                <p><i class="fa fa-phone"></i> Phone (Morocco) : +212 </p>
                <p><i class="fa fa-envelope"></i> E-mail : spookyframework@gmail.com</p>

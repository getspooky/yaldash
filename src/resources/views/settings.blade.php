...
@section("content")
    ...
    @component("LaravelDashboard::components.navbar")
        ...
        @component("LaravelDashboard::components.validation")
                    ...
                    <div class="card card-small mb-4 pt-3">
                        ...
                        <div class="card-header border-bottom text-center">
                            ...
                            <div class="mb-3 mx-auto">
                                <img class="rounded-circle" onclick="document.getElementById('file').click()" src="{{ \Yasser\LaravelDashboard\Helper\Helper::UploadedAvatar(\App\User::find(auth()->id())) }}" alt="User Avatar" width="110" height="110">
                            </div>
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item px-4">
                                <div class="progress-wrapper">
                                    ...
                                    <div class="progress progress-sm">
                                        <div class="progress-bar bg-danger" role="progressbar" aria-valuenow="74" aria-valuemin="0" aria-valuemax="100" style="width:{{ \Yasser\LaravelDashboard\Helper\Helper::Level(auth()->id()) }}%;">
                                            <span class="progress-value">{{ \Yasser\LaravelDashboard\Helper\Helper::Subscribers_count(auth()->id()) }}</span>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item p-4">
                                ...
                                <span>{{ \Yasser\LaravelDashboard\Helper\Helper::GlobalInformation('Description') }}</span>
                            </li>
                        </ul>
                    </div>
                </div>

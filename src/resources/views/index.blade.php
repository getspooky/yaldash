...
@section("content")
             ...
             @component("LaravelDashboard::components.navbar")
                   ...
                   <!-- Introduction -->
                    ...
                    <article id="top" class="wrapper style1">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-4">
                                    <span class="image fit"><img src="{{ \Yasser\LaravelDashboard\Helper\Helper::UploadedAvatar(\App\User::find(auth()->id())) }}" alt="" /></span>
                                </div>
                                <div class="col-lg-7 col-7-large col-12-medium">
                                    ...
                                    <a href="{{ config('laravelDash.views.Dashboard.intro_button') }}" class="button-intro-large">{{ config('laravelDash.views.Dashboard.intro_button') }}</a>
                                </div>
                            </div>
                        </div>
                    </article>
                ...
                @component("LaravelDashboard::components.state",['POST'=>$POST,'EARNINGS'=>$EARNINGS])
                ...
                <div class="row mt-5">
                    ...
                    <!-- Launch your Campaign -->
                     ...
                     @component("LaravelDashboard::components.referrals")
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12 mb-4">
                            <div class="card card-small">
                                ...
                                <div class="card-footer border-top">
                                    <div class="row">
                                        <img src="{{ \Yasser\LaravelDashboard\Helper\Assets::loadImg('post.png') }}" style="position:relative;width:100%;height:100%;object-fit:cover;margin-bottom:30px;">
            ...
            @component("LaravelDashboard::components.footer",["top"=>"-55px"])
